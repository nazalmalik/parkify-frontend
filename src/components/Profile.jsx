  ...
  useEffect(() => {
    const fetchProfileAndBookings = async () => {
      try {
        ...
        const userRes = await axios.get("https://parkify-backend-six.vercel.app/api/auth/profile", { headers });
        setUser(userRes.data);

        const bookingsRes = await axios.get("https://parkify-backend-six.vercel.app/api/bookings/my-bookings", { headers });
